  ...
  return (
    <section className="section-shell py-14 sm:py-16">
      <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
        <p className="text-xs font-semibold uppercase tracking-wider text-arena-sand">Team Tracker</p>
        <h1 className="mt-4 text-4xl font-bold uppercase text-arena-goldBright">Battle Progress</h1>
        ...
        <div className="mt-8">
          <div className="panel-card p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs uppercase tracking-wider text-arena-sand">Overall Progress</p>
